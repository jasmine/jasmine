jasmineRequire.HtmlReporter = function() {
  function HtmlReporter(options) {
    ...
    var buildForm = function() {
      var raise = createDom("input", { className: "raise", id: "raise-exceptions", name: "raise", type: "checkbox" });
      raise.checked = env.raisingExceptions();
      raise.onclick = reload;

      var refresh = createDom("input", { className: "refresh", id: "auto-refresh", name: "auto-refresh", type: "checkbox"});
